...
class user:
    def __init__(self, username ,  user_feature, user_ratedCareers, ratedcareers, unratedCareers, feature_names, feature_unratedCareers, ratedcareer_feature, predictionNames, user_Predictions, names) :
